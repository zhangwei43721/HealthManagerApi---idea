...
| 获取用户信息 (根据 Token)  | GET       | `/user/info`                           | `token` (查询参数): String                                                                        | `Map<String, Object>` (包含用户详细信息, `roles`: List<String>, `name`: String, `avatar`: String 等)             | `code: 20003, message: "登录信息有误，请重新登录"` |
...
| 获取用户体征记录日志 (Token) | GET       | `/user/WxgetBodyNotes/{token}` | `token` (路径参数): String                                                                         | `Map<String, Object>` (包含 `id`, `name`, `bodyNotes`: List<[`BodyNotes`](#bodynotes)>)     | `code: 20003, message: "登录信息有误，请重新登录"` |
...
| :----------------------------------- | :-------- | :------------------------- | :-------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- |
| AI 聊天流 (默认模型, 支持图片)     | POST      | `/chatStream`              | `token` (表单): String, `message` (表单): String, `file` (可选, 表单): MultipartFile, `conversationId` (可选, 表单): String | SSE 事件流 (`message`: String, `error`: String, `conversationId`: String)                               | SSE 事件流 (`error`) 或 HTTP 错误                                           |
| AI 聊天流 (中文模型, deepseek)     | POST      | `/chatStream/chinese`      | `token`: String, `question`: String, `conversationId` (可选): String (查询参数)                     | SSE 事件流 (`message`: String, `error`: String, `conversationId`: String)                               | SSE 事件流 (`error`) 或 HTTP 错误                                           |
